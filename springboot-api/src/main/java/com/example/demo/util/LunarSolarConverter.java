...
/**
 * created by zhangjingchuan on 2020/3/24
 */
@Service
...
//                    '}';
            ...
            sb.append(year).append("年").append(getMonth()).append("月").append(getDay());
            return sb.toString();
        }
    }
...
//        DateTime dateTime = new DateTime(2020,2,1,0,0,DateTimeZone.UTC);
//        dateTime.getMillis()
        DateTime dateTime = new DateTime("2020-6-1", DateTimeZone.UTC);
        Lunar lunar = LunarSolarConverter.converterDate(dateTime.getMillis());
