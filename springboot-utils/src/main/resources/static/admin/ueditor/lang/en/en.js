...
UE.I18N['en'] = {
    ...
    'autoupload': {
        ...
        'errorLoadConfig': 'Server com.example.limitierredis.config not loaded, upload can not work.',
    },
    'simpleupload':{
        'exceedSizeError': 'File Size Exceed',
        'exceedTypeError': 'File Type Not Allow',
    ...
    'loadconfigError': 'Get server com.example.limitierredis.config error.',
    'loadconfigFormatError': 'Server com.example.limitierredis.config format error.',
    'loadconfigHttpError': 'Get server com.example.limitierredis.config http error.',
    'snapScreen_plugin':{
        'browserMsg':"Only IE supported!",
        'callBackErrorMsg':"The callback data is wrong,please check the com.example.limitierredis.config!",
